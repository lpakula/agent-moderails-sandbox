export default function LearnMore() {
  return (
    <main className="min-h-screen bg-white dark:bg-gray-900">
      {/* Hero Section */}
      <section className="relative bg-gray-50 dark:bg-gray-800 py-20 px-6 sm:py-32">
      ...
      <section className="bg-gray-50 dark:bg-gray-800 py-16 px-6 sm:py-24">
        <div className="mx-auto max-w-7xl">
      ...
      <section className="bg-gray-900 dark:bg-gray-950 py-16 px-6 sm:py-24">
        <div className="mx-auto max-w-7xl text-center">
          <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
            Ready to Start Shopping?
          </h2>
          <p className="mt-6 text-lg leading-8 text-gray-300 dark:text-gray-400 max-w-2xl mx-auto">
            Explore our full collection of premium products and find something perfect for you.
          </p>
          <div className="mt-10">
            <a
              href="/"
              className="rounded-md bg-white dark:bg-gray-100 px-6 py-3 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-100 dark:hover:bg-white transition-colors inline-block"
            >
              Back to Home
            </a>
          </div>
